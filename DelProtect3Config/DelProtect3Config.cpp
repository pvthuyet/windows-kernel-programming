// DelProtect3Config.cpp : This file contains the 'main' function. Program execution begins and ends there.
//

#include <iostream>
#include <Windows.h>
#include "..\DelProtect3\DelProtect3Common.h"
...
int wmain(int argc, const wchar_t* argv[]) {
	...
	HANDLE hDevice = ::CreateFile(USER_FILE_NAME, GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE,
