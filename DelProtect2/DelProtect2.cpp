...
Abstract:
    ...
    This is the main module of the DelProtect2 miniFilter driver.
...
VOID
DelProtect2InstanceTeardownStart (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_TEARDOWN_FLAGS Flags
    );

VOID
DelProtect2InstanceTeardownComplete (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_TEARDOWN_FLAGS Flags
    );
...
NTSTATUS
DelProtect2InstanceQueryTeardown (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _In_ FLT_INSTANCE_QUERY_TEARDOWN_FLAGS Flags
    );

FLT_PREOP_CALLBACK_STATUS
DelProtect2PreOperation (
    _Inout_ PFLT_CALLBACK_DATA Data,
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _Flt_CompletionContext_Outptr_ PVOID *CompletionContext
    );
...
VOID
DelProtect2OperationStatusCallback (
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
...
FLT_PREOP_CALLBACK_STATUS
DelProtect2PreOperationNoPostOperation (
    _Inout_ PFLT_CALLBACK_DATA Data,
    _In_ PCFLT_RELATED_OBJECTS FltObjects,
    _Flt_CompletionContext_Outptr_ PVOID *CompletionContext
    );
...
BOOLEAN
DelProtect2DoRequestOperationStatus(
...
#pragma alloc_text(PAGE, DelProtect2Unload)
#pragma alloc_text(PAGE, DelProtect2InstanceQueryTeardown)
#pragma alloc_text(PAGE, DelProtect2InstanceSetup)
#pragma alloc_text(PAGE, DelProtect2InstanceTeardownStart)
#pragma alloc_text(PAGE, DelProtect2InstanceTeardownComplete)
#endif
...
CONST FLT_REGISTRATION FilterRegistration = {
    ...
    DelProtect2Unload,                           //  MiniFilterUnload

    DelProtect2InstanceSetup,                    //  InstanceSetup
    DelProtect2InstanceQueryTeardown,            //  InstanceQueryTeardown
    DelProtect2InstanceTeardownStart,            //  InstanceTeardownStart
    DelProtect2InstanceTeardownComplete,         //  InstanceTeardownComplete
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2InstanceSetup: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2InstanceQueryTeardown: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2InstanceTeardownStart: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2InstanceTeardownComplete: Entered\n") );
}
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2Unload: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2PreOperation: Entered\n") );
    ...
    if (DelProtect2DoRequestOperationStatus( Data )) {
        ...
        if (!NT_SUCCESS(status)) {
            ...
            PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                          ("DelProtect2!DelProtect2PreOperation: FltRequestOperationStatusCallback Failed, status=%08x\n",
                           status) );
        }
    }
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2OperationStatusCallback: Entered\n") );

    PT_DBG_PRINT( PTDBG_TRACE_OPERATION_STATUS,
                  ("DelProtect2!DelProtect2OperationStatusCallback: Status=%08x ctx=%p IrpMj=%02x.%02x \"%s\"\n",
                   OperationStatus,
                   RequesterContext,
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2PostOperation: Entered\n") );
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("DelProtect2!DelProtect2PreOperationNoPostOperation: Entered\n") );
